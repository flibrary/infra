{
  ...
  outputs = { self, nixpkgs, deploy-rs, utils, ... }:
    utils.lib.eachSystem (utils.lib.defaultSystems) (system: rec {
      ...
      # Bootstrap system (TODO: change it to a small subsystem maybe?)
      bootstrap =
        self.nixosConfigurations.flibrary-silicon-valley.config.system.build.toplevel;
      ...
      nixosConfigurations = {
        ...
        flibrary-silicon-valley = nixpkgs.lib.nixosSystem {
